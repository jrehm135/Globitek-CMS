...
<img src='https://imgur.com/a/L7jFe' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

It took a little bit of time to make sure that the php section of my code was working, as I have
not really worked with it before. Once I got the errors to display, I had a little bit of difficulty
submitting the data to MySQL, but it eventually got resolved. 

## License

    Copyright 2018 Josh Rehm
